  ...
  <CheatBox title="Erfolgsrechnung mehrstufig (EBITDA)">
    ...
    <div className="horizontal">
      <div className="vertical">
        <img style={{ width: "100%" }} src={ebitda} alt="Erfolgsrechnung" />
        <img style={{ width: "100%" }} src={ebitdaBsp} alt="Erfolgsrechnung" />
      </div>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Diese Grösse misst den betrieblichen Erfolg vor den Steuern.
            </td>
          </tr>
        </tbody>
      </table>
